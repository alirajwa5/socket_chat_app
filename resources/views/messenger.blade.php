...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('web/images/favicon/favicon.png') }}" type="image/x-icon">
...
<body class="sidebar-active">
    <div class="chitchat-loader">
        <div><img src="{{ asset('web/images/logo/logo_big.png') }}" alt="" />
    ...
    <div class="chitchat-container sidebar-toggle">
        <nav class="main-nav on custom-scroll">
            <div class="logo-warpper"><a href="messenger.html"><img src="{{ asset('web/images/logo/logo.png') }}"
                        alt="logo" /></a></div>
            <div class="sidebar-main">
                <ul class="sidebar-top">
                    <li><a class="button-effect" href="status.html" data-tippy-content="status"
                            data-intro="Check Status here">
                            <div class="user-popup status one">
                                <div> <img class="bg-img" src="{{ asset('web/images/avtar/2.jpg') }}" alt="Avatar" />
                                </div>
                            </div>
                        </a></li>
                    <li><a class="icon-btn btn-light button-effect" href="favourite" data-tippy-content="Favourite"><i
                                class="fa fa-star"></i></a></li>
                    <li><a class="icon-btn btn-light button-effect" href="document" data-tippy-content="Document"> <i
                    ...
                    <li>
                        <div class="dot-btn dot-danger grow"><a class="icon-btn btn-light button-effect"
                                href="notification" data-tippy-content="Notification"> <i class="fa fa-bell"></i></a>
                        </div>
                    </li>
                ...
                <ul class="sidebar-bottom">
                    ...
                    <li><a class="icon-btn btn-light" href="login.html" data-tippy-content=" SignOut"> <i
            ...
            <div class="recent-default dynemic-sidebar active">
                    ...
                    <div class="theme-title">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1"><a
                                    ...
                                    class="icon-btn btn-outline-light button-effect pull-right mainnav"
                                    href="#"><i class="ti-layout-grid2"></i></a></div>
                        </div>
                    </div>
                    <div class="recent-slider recent-chat owl-carousel owl-theme">
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile"><img class="bg-img"
                                        src="{{ asset('web/images/avtar/1.jpg') }}" alt="Avatar" />
                                    <h6> John deo</h6>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile online"><img class="bg-img"
                                        src="{{ asset('web/images/avtar/big/audiocall.jpg') }}" alt="Avatar" />
                                    <h6> John </h6>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="recent-box">
                                ...
                                <div class="recent-profile"><img class="bg-img"
                                        src="{{ asset('web/images/avtar/2.jpg') }}" alt="Avatar" />
                                    <h6> Jpny</h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="chat custom-scroll">
                    <ul class="chat-cont-setting">
                        ...
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#msgcallModal"><span>new
                                    call</span>
                                <div class="icon-btn btn-outline-success button-effect btn-sm"><i
                                        data-feather="phone"></i></div>
                            </a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><span>new
                                    Contact</span>
                                <div class="icon-btn btn-outline-danger button-effect btn-sm"><i
                    ...
                    <div class="theme-tab tab-sm chat-tabs">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" data-to="call-content"><a class="nav-link button-effect"
                                    id="call-tab" data-bs-toggle="tab" href="#call" role="tab"
                                    aria-controls="call" aria-selected="false"><i data-feather="phone"> </i>Call</a>
                            </li>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile offline"><img class="bg-img"
                                                                src="{{ asset('web/images/contact/1.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                                ...
                                                <li class="active" data-to="chating">
                                                    <div class="chat-box">
                                                        <div class="profile online"><img class="bg-img"
                                                                src="{{ asset('web/images/contact/2.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                            <h6>Typing................</h6>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile unreachable"><img class="bg-img"
                                                                src="{{ asset('web/images/contact/3.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Sufiya Elija</h5>
                                                ...
                                                <li data-to="blank">
                                                    <div class="chat-box">
                                                        <div class="profile busy"><img class="bg-img"
                                                                src="{{ asset('web/images/contact/4.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                        ...
                                        <div class="tab-pane fade" id="group" role="tabpanel"
                                            ...
                                            <ul class="group-main">
                                                <li class="active" data-to="group_chat">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img"
                                                                src="{{ asset('web/images/avtar/teq.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Tech Ninjas</h5>
                                                        ...
                                                        <div class="date-status">
                                                            <ul class="grop-icon">
                                                                <li><a class="group-tp" href="#"
                                                                        data-tippy-content="Josephin"> <img
                                                                            src="{{ asset('web/images/contact/1.jpg') }}"
                                                                            alt="group-icon-img" /></a></li>
                                                                <li><a class="group-tp" href="#"
                                                                        data-tippy-content="Jony "> <img
                                                                            src="{{ asset('web/images/contact/2.jpg') }}"
                                                                            alt="group-icon-img" /></a></li>
                                                                <li><a class="group-tp" href="#"
                                                                        data-tippy-content="Pabelo"> <img
                                                                            src="{{ asset('web/images/contact/3.jpg') }}"
                                                                            alt="group-icon-img" /></a></li>
                                                                <li>+ 35</li>
                                                            </ul>
                                                ...
                                                <li data-to="group_blank">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img"
                                                                src="{{ asset('web/images/avtar/family.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                                            <h5>Family Ties</h5>
                                                            <h6>Lorem Ipsum is simply dummy text the printing and
                                                ...
                                                <li data-to="group_blank">
                                                    <div class="group-box">
                                                        <div class="profile"><img class="bg-img"
                                                                src="{{ asset('web/images/avtar/girls.jpg') }}"
                                                                alt="Avatar" /></div>
                                                        <div class="details">
                                ...
                                <div class="theme-tab tab-icon">
                                    <ul class="nav nav-tabs" id="contactTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="con1-tab"
                                                data-bs-toggle="tab" href="#con1" role="tab"
                                                aria-controls="con1" aria-selected="true">All</a></li>
                                                ...
                                                <li class="active">
                                                    <div class="call-box">
                                                        ...
                                                        <div class="call-status">
                                                            <div
                                                                class="icon-btn btn-outline-success button-effect btn-sm">
                                                ...
                                                <li>
                                                    <div class="call-box">
                                                        ...
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                            <h6> <i class="missed"
                                                                    data-feather="corner-left-down"></i>3:00 pm</h6>
                                                        </div>
                                                        <div class="call-status">
                                                            <div
                                                ...
                                                <li class="active">
                                                    <div class="call-box">
                                                        ...
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                            <h6> <i class="missed"
                                                                    data-feather="corner-left-down"></i>3:30 pm</h6>
                                                        </div>
                                                        <div class="call-status">
                                                            <div
                                                                class="icon-btn btn-outline-danger button-effect btn-sm">
                                                ...
                                                <li>
                                                    <div class="call-box">
                                                        ...
                                                        <div class="details">
                                                            <h5>Jony Lynetin</h5>
                                                            <h6> <i class="missed"
                                                                    data-feather="corner-left-down"></i>3:10 pm</h6>
                                                        </div>
                                                        <div class="call-status">
                                                            <div
                                                                class="icon-btn btn-outline-danger button-effect btn-sm">
                                ...
                                <ul class="contact-log-main">
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile offline"><img class="bg-img"
                                                    src="{{ asset('web/images/contact/2.jpg') }}" alt="Avatar" />
                                            </div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+21 3523 25544 </h6>
                                    ...
                                    <li class="active">
                                        <div class="contact-box">
                                            <div class="profile online"><img class="bg-img"
                                                    src="{{ asset('web/images/contact/1.jpg') }}" alt="Avatar" />
                                            </div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+54 541447 255 </h6>
                                    ...
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile busy"><img class="bg-img"
                                                    src="{{ asset('web/images/contact/3.jpg') }}" alt="Avatar" />
                                            </div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+58 2564 02554</h6>
                                    ...
                                    <li>
                                        <div class="contact-box">
                                            <div class="profile unreachable"><img class="bg-img"
                                                    src="{{ asset('web/images/contact/4.jpg') }}" alt="Avatar" />
                                            </div>
                                            <div class="details">
                                                <h5>Jony Lynetin</h5>
                                                <h6>+44 55124 2524</h6>
            ...
            <div class="fevorite-tab custom-scrollbar dynemic-sidebar" id="favourite">
                <div class="theme-title">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm m-r-15 search"
                            ...
                            <form class="form-inline search-form">
                                ...
                                data-bs-toggle="modal" data-bs-target="#addcallmodal"><i data-feather="plus">
                ...
                <ul class="chat-main">
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                <div class="profile offline"><img class="bg-img"
                                        src="{{ asset('web/images/contact/1.jpg') }}" alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Josephin water</h5>
                                    <h6>Alabma , USA</h6>
                                </div>
                                <div class="flex-grow-1"><a
                                        class="icon-btn btn-outline-primary btn-sm pull-right favourite"
                    ...
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                <div class="profile online"><img class="bg-img"
                                        src="{{ asset('web/images/contact/2.jpg') }}" alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Jony Lynetin</h5>
                    ...
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                <div class="profile busy"><img class="bg-img"
                                        src="{{ asset('web/images/contact/3.jpg') }}" alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Sufiya Elija</h5>
                    ...
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                <div class="profile unreachable"><img class="bg-img"
                                        src="{{ asset('web/images/contact/4.jpg') }}" alt="Avatar" /></div>
                                <div class="details">
                                    <h5>Pabelo Mukrani</h5>
                    ...
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right"
                                        href="https://themes.pixelstrap.com/chitchat/assets/doc/messenger.html"
                                        target="_blank"><i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right"
                                        href="https://themes.pixelstrap.com/chitchat/assets/doc/chapter1.MP4"
                                        target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right"
                                        href="https://themes.pixelstrap.com/chitchat/assets/doc/salary.xlsx"
                                        target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right"
                                        href="https://themes.pixelstrap.com/chitchat/assets/doc/document.pdf"
                                        target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="chat-box">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1"><a class="icon-btn btn-outline-light btn-sm pull-right"
                                        href="https://themes.pixelstrap.com/chitchat/assets/doc/details.txt"
                                        target="_blank"> <i data-feather="download"></i></a></div>
                            </div>
                        </div>
                    </li>
                ...
                <div class="theme-title">
                    ...
                    <div class="profile-box">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1"><a
                                    class="icon-btn btn-outline-light btn-sm pull-right edit-btn" href="#"> <i
                    ...
                    <div class="block">
                        <div class="d-flex">
                            ...
                            <div class="media-right"><a
                                    class="icon-btn btn-outline-light btn-sm pull-right previous" href="#"> <i
                                        data-feather="chevron-left"> </i></a></div>
                        </div>
                        <div class="theme-according" id="accordion">
                            <div class="card">
                                <div class="card-header" id="headingTwo" role="heading"
                                    data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true"
                                    aria-controls="collapseTwo"><a>Security<i class="fa fa-angle-down"></i></a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne" role="heading"
                                    ...
                                    aria-controls="collapseOne"><a>Privacy<i class="fa fa-angle-down"></i></a></div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree" role="heading"
                                    ...
                                    aria-expanded="false" aria-controls="collapseThree"><a>Two Step verification<i
                            ...
                            <div class="card">
                                <div class="card-header" id="headingFour" role="heading"
                                    ...
                                    aria-controls="collapseFour"><a>Change Number<i
                                            class="fa fa-angle-down"></i></a></div>
                                <div class="collapse" id="collapseFour" aria-labelledby="headingFour"
                                    ...
                                    <div class="card-body change-number">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control country-code" type="number"
                                                placeholder="01" />
                                        ...
                                        <div class="text-end"> <a
                                                class="btn btn-outline-primary button-effect btn-sm"
                                                href="#">confirm</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingFive" role="heading"
                                    ...
                                    aria-controls="collapseFive"><a>Request account info<i
                                            class="fa fa-angle-down"></i></a></div>
                                <div class="collapse" id="collapseFive" aria-labelledby="headingFive"
                                    ...
                                    <div class="card-body"><a class="p-0 req-info" id="demo" href="#"
                                        ...
                                        <p> <b>Note : </b>Create a report of your account information and settings,
                                            which you can access ot port to another app.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                    ...
                    <div class="block">
                        ...
                        <ul class="help">
                            ...
                            <li>
                                ...
                                <ul class="wallpaper">
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/2.jpg') }}"
                                            alt="Avatar" /></li>
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/1.jpg') }}"
                                            alt="Avatar" /></li>
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/3.jpg') }}"
                                            alt="Avatar" /></li>
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/4.jpg') }}"
                                            alt="Avatar" /></li>
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/5.jpg') }}"
                                            alt="Avatar" /></li>
                                    <li><img class="bg-img" src="{{ asset('web/images/wallpaper/6.jpg') }}"
                                            alt="Avatar" /></li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div class="d-flex">
                            <div class="img-status">
                                <div class="user-status two"><img class="img-fluid bg-img"
                                        src="{{ asset('web/images/avtar/girls.jpg') }}" alt="status" /></div>
                            ...
                            <div><a class="icon-btn btn-outline-light btn-sm close-panel" href="#"><i
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox"><img
                                        ...
                                        src="{{ asset('web/images/status-img/small/sm-1.jpg') }}"
                                        alt="status" /></a>
                                <div class="lightbox-target" id="statusbox"><img
                                        src="{{ asset('web/images/status-img/large/lg-1.jpg') }}"
                                        alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Josephin water</h5>
                                <p>today , 8:30am</p>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox2"><img
                                        class="img-fluid bg-img"
                                        src="{{ asset('web/images/status-img/small/sm-2.jpg') }}"
                                        alt="status" /></a>
                                <div class="lightbox-target" id="statusbox2"><img
                                        src="{{ asset('web/images/status-img/large/lg-2.jpg') }}"
                                        alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Jony Lynetin</h5>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox3"><img
                                        class="img-fluid bg-img"
                                        src="{{ asset('web/images/status-img/small/sm-3.jpg') }}"
                                        alt="status" /></a>
                                <div class="lightbox-target" id="statusbox3"><img
                                        src="{{ asset('web/images/status-img/large/lg-3.jpg') }}"
                                        alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Sufiya Elija</h5>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox4"><img
                                        class="img-fluid bg-img"
                                        src="{{ asset('web/images/status-img/small/sm-4.jpg') }}"
                                        alt="status" /></a>
                                <div class="lightbox-target" id="statusbox4"><img
                                        src="{{ asset('web/images/status-img/large/lg-4.jpg') }}"
                                        alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Mukrani Pabelo </h5>
                    ...
                    <div class="status-content">
                        <ul>
                            <li class="user-status"><a class="lightbox img-status status" href="#statusbox5"><img
                                        class="img-fluid bg-img"
                                        src="{{ asset('web/images/status-img/small/sm-5.jpg') }}"
                                        alt="status" /></a>
                                <div class="lightbox-target" id="statusbox5"><img
                                        src="{{ asset('web/images/status-img/large/lg-5.jpg') }}"
                                        alt="status" /><a class="lightbox-close" href="#"></a></div>
                            </li>
                            <li>
                                <h5>Pabelo Mukrani</h5>
        ...
        <div class="chitchat-main small-sidebar" id="content">
            <div class="chat-content tabto active">
                    ...
                    <div class="contact-chat">
                        <ul class="chatappend">
                                                ...
                                                <li class="msg-setting-main">
                                                    <div class="msg-dropdown-main">
                                                        ...
                                                        <div class="msg-dropdown">
                                                            <ul>
                                                                <li><a href="#"><i
                                                                            class="fa fa-share"></i>forward</a></li>
                                                                <li><a href="#"><i
                                                                            class="fa fa-clone"></i>copy</a></li>
                                                                <li><a href="#"><i
                                                                            class="fa fa-star-o"></i>rating</a></li>
                                                                <li><a href="#"><i
                                                                            class="ti-trash"></i>delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <h5>Hi I am Alan,</h5>
                            ...
                            <li class="replies">
                                <div class="d-flex">
                                    <div class="profile"><img class="bg-img"
                                            src="{{ asset('web/images/avtar/1.jpg') }}" alt="Avatar" /></div>
                                    <div class="flex-grow-1">
                                        <div class="contact-name">
                                            <h5>Alan josheph</h5>
                                            <h6>01:40 AM</h6>
                                                ...
                                                <li class="msg-setting-main">
                                                    <div class="document"><i
                                                        ...
                                                        <div class="icon-btns"><a class="icon-btn btn-outline-light"
                                                                href="https://themes.pixelstrap.com/chitchat/assets/doc/Document.xlsx"
                                            ...
                                            <ul class="msg-box">
                                                ...
                                                <li class="msg-setting-main">
                                                    <ul class="auto-gallery">
                                                        <li><img class="bg-img"
                                                                src="{{ asset('web/images/media/1.jpg') }}"
                                                                alt="Avatar" /></li>
                                                        <li> <img class="bg-img"
                                                                src="{{ asset('web/images/media/2.jpg') }}"
                                                                alt="Avatar" /></li>
                                                        <li> <img class="bg-img"
                                                                src="{{ asset('web/images/media/3.jpg') }}"
                                                                alt="Avatar" /></li>
                                                    </ul>
                                                    <div class="refresh-block">
                                                        <div class="badge badge-outline-primary refresh sm"><i
                                                    ...
                                                    <div class="msg-dropdown-main">
                                                        ...
                                                        <div class="msg-dropdown">
                                                            <ul>
                                                                ...
                                                                <li><a href="#"><i
                                                                            class="fa fa-star-o"></i>rating</a></li>
                                                                <li><a href="#"><i class="ti-trash"></i>delete
                                                                    </a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                ...
                <div class="messages custom-scroll" id="blank">
                                            ...
                                            <li><a class="icon-btn btn-light search search-right" href="#"> <i
                                                ...
                                                <form class="form-inline search-form">
                                                    <div class="form-group">
                                                        <input class="form-control-plaintext" type="search"
                                                            placeholder="Search.." />
                                                        <div class="icon-close close-search"> <i
                    ...
                    <div class="call-list-center"><img src="{{ asset('web/images/chat.png') }}"
                            alt="" />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex left">
                                    <div class="media-left me-3">
                                        <div class="profile online menu-trigger"><img class="bg-img"
                                                src="{{ asset('web/images/avtar/teq.jpg') }}" alt="Avatar" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h5>Tech Ninjas</h5>
                            ...
                            <div class="col">
                                <ul class="calls text-end">
                                    ...
                                    <li class="chat-friend-toggle"><a
                                            class="icon-btn btn-light bg-transparent button-effect outside"
                                            href="#" data-tippy-content="Quick action"></a>
                                        <div class="chat-frind-content">
                                            <ul>
                                                <li><a class="icon-btn btn-outline-primary button-effect btn-sm"
                                                        href="#"><i data-feather="user"></i></a>
                        ...
                        <ul class="chatappend">
                            <li class="groupuser">
                                                ...
                                                <div class="chat-box">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1"><a
                                                                ...
                                                                href="#" data-tippy-content="Add User"><i
                                ...
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img"
                                        src="{{ asset('web/images/avtar/3.jpg') }}" alt="Avatar" /></div>
                                <div class="gr-profile dot-btn dot-success grow"><img class="bg-img"
                                        src="{{ asset('web/images/avtar/5.jpg') }}" alt="Avatar" /></div>
                            </li>
                            <li class="sent">
                                <div class="d-flex">
                                    <div class="profile"><img class="bg-img"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex left">
                                    <div class="media-left me-3">
                                        <div class="profile online menu-trigger"><img class="bg-img"
                                                src="{{ asset('web/images/avtar/family.jpg') }}" alt="Avatar" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h5>Family Ties</h5>
                ...
                <div class="message-input">
                    <div class="wrap emojis-main"><a
                            class="icon-btn btn-outline-primary button-effect toggle-sticker outside"
                            href="#">
                            <svg id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="2158px"
                                height="2148px" viewbox="0 0 2158 2148" enable-background="new 0 0 2158 2148"
                                xml:space="preserve">
                        ...
                        <div class="dot-btn dot-primary"><a
                                class="icon-btn btn-outline-primary button-effect toggle-emoji" href="#"><i
                                    data-feather="smile"></i></a></div>
                        <div class="contact-poll"><a class="icon-btn btn-outline-primary outside"
                        ...
                        <input class="setemoj" id="setemoj" type="text"
                            placeholder="Write your message..." /><a
                            class="icon-btn btn-outline-primary button-effect me-2 ms-2" href="#"><i
                            ...
                            <div class="sticker-sub-contain custom-scroll">
                                <ul>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/1.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/2.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/3.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/3.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/4.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/5.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/6.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/7.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/8.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/9.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/10.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/11.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/12.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/13.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/14.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/15.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/16.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/17.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/18.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/19.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/20.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/21.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/22.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/23.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/24.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/25.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/26.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/27.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/28.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/29.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/30.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/31.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/32.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/33.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/34.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/35.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/36.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/37.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/38.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/39.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/40.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/41.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/42.gif') }}"
                                                alt="sticker" /></a></li>
                                    <li><a href="#"><img class="img-fluid"
                                                src="{{ asset('web/images/sticker/43.gif') }}"
                                                alt="sticker" /></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="user-profile mb-3">
                            <div class="user-content"><img class="img-fluid"
                                    src="{{ asset('web/images/contact/2.jpg') }}" alt="user-img" />
            ...
            <div class="contact-content tabto">
                <div class="contact-sub-content"><a
        ...
        <aside class="chitchat-right-sidebar" id="slide-menu">
            <div class="custom-scroll right-sidebar">
                <div class="contact-profile">
                    ...
                    <div class="details">
                        <div class="contact-top"><img class="bg-img" src="{{ asset('web/images/avtar/2.jpg') }}"
                                alt="" /></div>
                        <div class="name">
                            <h3>Josephin water</h3>
                        ...
                        <ul class="medialogo">
                            <li><a class="icon-btn btn-danger button-effect" href="https://www.google.com/"><i
                                        class="fa fa-google"></i></a></li>
                            <li><a class="icon-btn btn-primary button-effect" href="https://twitter.com/"><i
                                        class="fa fa-twitter"></i></a></li>
                            <li><a class="icon-btn btn-facebook button-effect" href="https://www.facebook.com/"><i
                            ...
                            <div class="row share-media zoom-gallery">
                                ...
                                <div class="col-4">
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a
                                                    href="{{ asset('web/images/gallery/2.jpg') }}">
                                                    <div class="overlay-background"><i class="ti-plus"
                                                            aria-hidden="true"></i></div><img
                                                        class="img-fluid bg-img"
                                                        src="{{ asset('web/images/gallery/2.jpg') }}"
                                                        alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a
                                                    href="{{ asset('web/images/gallery/3.jpg') }}">
                                                    <div class="overlay-background"><i class="ti-plus"
                                                            aria-hidden="true"></i></div><img
                                                        class="img-fluid bg-img"
                                                        src="{{ asset('web/images/gallery/3.jpg') }}"
                                                        alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="media-small isotopeSelector filter">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a
                                                    href="{{ asset('web/images/gallery/4.jpg') }}">
                                                    <div class="overlay-background"><i class="ti-plus"
                                                            aria-hidden="true"></i></div><img
                                                        class="img-fluid bg-img"
                                                        src="{{ asset('web/images/gallery/4.jpg') }}"
                                                        alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
                                    <div class="media-small isotopeSelector filter fashion">
                                        <div class="overlay">
                                            <div class="border-portfolio"><a
                                                    href="{{ asset('web/images/gallery/5.jpg') }}">
                                                    <div class="overlay-background"><i class="ti-plus"
                                                            aria-hidden="true"></i></div><img
                                                        class="img-fluid bg-img"
                                                        src="{{ asset('web/images/gallery/5.jpg') }}"
                                                        alt="portfolio-image" />
                                                </a></div>
                                        </div>
                                    </div>
        ...
        <aside class="app-sidebar active">
                        ...
                        <div class="todo-main">
                            <div class="theme-title">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1"><a class="icon-btn btn-sm btn-outline-light close-apps"
                                            href="#"><i data-feather="x"></i></a></div>
                                </div>
                            </div>
                            <div class="todo-name">
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/12.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/3.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/8.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/9.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                                <h5>HTML Template.</h5>
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/11.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/10.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/7.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/4.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/6.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="link-group mb-5">
                                        ...
                                        <div class="d-flex"><img class="img-fluid"
                                                src="{{ asset('web/images/file_icons/5.png') }}"
                                                alt="media-img" />
                                            <div class="flex-grow-1">
                                            ...
                                            <div class="chat-box">
                                                <div class="d-flex">
                                                    <div class="profile"><a
                                                            ...
                                                            href="#"><i class="fa fa-file-code-o"></i></a>
                                                    </div>
                                                    <div class="details">
                                                        <h5>messenger.html</h5>
                                                        <h6>2, octomber 2023</h6>
                                        ...
                                        <li>
                                            <div class="chat-box">
                                                <div class="d-flex">
                                                    <div class="profile"><a
                                                            class="icon-btn btn-outline-success btn-xl pull-right rouded15"
                                                            href="#"><i class="fa fa-file-video-o"></i></a>
                                                    </div>
                                                    <div class="details">
                                                        <h5>chapter1.MP4</h5>
                                                        <h6>3, Octomber 2023</h6>
                                        ...
                                        <li>
                                            <div class="chat-box">
                                                <div class="d-flex">
                                                    <div class="profile"><a
                                                            class="icon-btn btn-outline-primary btn-xl pull-right rouded15"
                                                            href="#"><i class="fa fa-file-word-o"></i></a>
                                                    </div>
                                                    <div class="details">
                                                        <h5>salary.xlsx</h5>
                                                        <h6>5, Octomber 2023</h6>
                        ...
                        <div class="notes-main">
                            ...
                            <form class="default-form">
                                <div class="form-group notes-content">
                                    ...
                                    <ul>
                                        <li><a class="icon-btn btn-light button-effect btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#notesModal"><i
                            ...
                            <div class="notes-list">
                                ...
                                <div class="d-flex"><img class="img-fluid me-3"
                                        src="{{ asset('web/images/file_icons/5.png') }}" alt="media-img" />
                                    <div class="flex-grow-1">
                                ...
                                <div class="forward-main"><a class="line fa fa-mail-forward"
                                        href="#">Forward </a></div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reminder-main">
                            ...
                            <div class="reminder-list">
                                ...
                                <div class="target-reminder-list">
                                    ...
                                    <ul class="reminder-disp">
                                        <li class="reminder-toggle"><a class="icon-btn bg-transparent"
                                                href="#" data-tippy-content="Quick action"><i
                                                    data-feather="more-vertical"></i></a>
            ...
            <div class="app-list">
                <ul class="app-list-ul custom-scroll">
                    ...
                    <li class="close-app"><a class="icon-btn btn-danger" href="#"
                            onclick="removedefault()"><i data-feather="x"></i></a>
                        <h5>close</h5>
                    </li>
                </ul>
            </div>
                ...
                <div class="modal-body">
                    <form class="default-form">
                        ...
                        <div class="form-group mb-0 text-center">
                            ...
                            <input class="form-control" id="examplemsg" type="number"
    ...
    <div class="modal pol-modal-main add-popup" id="pollModal" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="cke_editable cke_editable_inline cke_contents_ltr cke_show_borders"
                                ...
                                role="textbox" aria-label="Rich Text Editor, area1"
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec at vulputate urna, sed
                                    ...
                                    vitae commodo eget, rhoncus nec erat. Sed sapien turpis, elementum sit amet elit
                                    vitae, elementum gravida eros. In ornare tempus nibh ut lobortis. Nam venenatis
                                    justo ex, vitae vulputate neque laoreet a.</p>
                            </div>
                        </div>
            ...
            <div class="modal-content custom-scrollbar">
                ...
                <div class="modal-body">
                    <form class="form default-form">
                        ...
                        <div class="reminder-btn mb-3"><a class="btn btn-primary button-effect">set reminder</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal snippet-modal-main add-popup" id="snippetModal" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="default-form">
                        ...
                        <div class="form-group mb-0">
                            <div class="btn-snipate"><a class="btn btn-danger button-effect btn-sm me-3"
                                    href="#" data-bs-dismiss="modal" aria-label="Close">Cancel</a><a
                                    class="btn btn-primary button-effect btn-sm" href="#"
                                    data-bs-dismiss="modal" aria-label="Close">Create & post</a></div>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="center-con text-center">
                        ...
                        <ul>
                            <li><a class="icon-btn btn-success button-effect btn-xl is-animating" href="#"
                                    data-bs-toggle="modal" data-bs-target="#audiorcvcall" data-bs-dismiss="modal">
                                    <i data-feather="phone"></i></a></li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-body">
                <div class="videocall call-modal"><img class="bg-img"
                        src="{{ asset('web/images/avtar/big/videocall_bg.jpg') }}" alt="Avatar" />
                    <div class="small-image"><img class="bg-img"
                            src="{{ asset('web/images/avtar/big/videocall.jpg') }}" alt="Avatar" /></div>
                    <div class="d-flex gap-3 videocall-details">
                        <div class="usersprof">
                            <div class="profile"><img class="bg-img" src="{{ asset('web/images/avtar/2.jpg') }}"
                                    alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="{{ asset('web/images/avtar/3.jpg') }}"
                                    alt="Avatar" /></div>
                        </div>
                        <div class="flex-grow-1">
                            <h5>Josephin water</h5>
                        ...
                        <div class="zoomcontent"><a class="text-dark" href="#!"
                                onclick="javascript:toggleFullScreen()" data-tippy-content="Zoom Screen"><img
                                    src="https://themes.pixelstrap.com/chitchat/assets/images/logo/maximize.svg"
                                    alt="zoom screen" /></a></div>
                    </div>
                    <div class="center-con text-center">
                        <ul>
                ...
                <div class="conferencecall call-modal"><img class="bg-img"
                    ...
                    <div class="center-con text-center">
                        <div class="usersprof">
                            ...
                            <div class="profile"><img class="bg-img" src="{{ asset('web/images/avtar/3.jpg') }}"
                                    alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img" src="{{ asset('web/images/avtar/5.jpg') }}"
                                    alt="Avatar" /></div>
                            <div class="profile"><img class="bg-img"
                                    src="{{ asset('web/images/avtar/big/videocall_bg.jpg') }}" alt="Avatar" />
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row confimg">
                        ...
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="{{ asset('web/images/avtar/5.jpg') }}"
                                    alt="Avatar" /></div>
                        </div>
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="{{ asset('web/images/avtar/2.jpg') }}"
                                    alt="Avatar" /></div>
                        </div>
                        <div class="col-6">
                            <div class="vclimg"><img class="bg-img" src="{{ asset('web/images/avtar/3.jpg') }}"
                                    alt="Avatar" /></div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer clfooter">
                    ...
                    <ul>
                        <li><a class="icon-btn btn-light button-effect" href="#"
                                data-tippy-content="speaker"><i data-feather="volume-2"></i></a></li>
                        <li><a class="icon-btn btn-light button-effect" href="#"
                                data-tippy-content="Camera"><i data-feather="camera-off"></i></a></li>
                        <li><a class="icon-btn btn-light button-effect" href="#"
                        ...
                        <li><a class="icon-btn btn-light button-effect" href="#"
                                data-tippy-content="Hold"><i data-feather="pause"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="default-form">
                        ...
                        <div class="form-group text-center">
                            <h5>Contact number</h5>
                            <input class="form-control" id="examplemsg2" type="number"
                                placeholder="12345678912" />
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade add-popup msg-chat-modal" id="msgchatModal" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
