...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/js/ckeditor/skins/moono-lisa/editore8ef.css?t=HBDD') }}">
            ...
            <div class="login-contain-main">
              <div class="left-page">
                <div class="login-content">
                  <div class="login-content-header"><img class="image-fluid" src="{{ asset('assets/images/logo/landing-logo.png') }}" alt="images"></div>
              ...
              <div class="right-page">
                <div class="right-login animat-rate">
                  <div class="animation-block">
                    ...
                    <div class="right-circle1"></div><img class="heart-logo" src="{{ asset('assets/images/login_signup/5.png') }}" alt="login logo"/><img class="has-logo" src="../assets/images/login_signup/4.png" alt="login logo"/><img class="login-img" src="../assets/images/login_signup/1.png" alt="login logo"/><img class="boy-logo" src="../assets/images/login_signup/6.png" alt="login boy logo"/><img class="girl-logo" src="../assets/images/login_signup/7.png" alt="girllogo"/><img class="cloud-logo" src="../assets/images/login_signup/2.png" alt="login logo"/><img class="cloud-logo1" src="../assets/images/login_signup/2.png" alt="login logo"/><img class="cloud-logo2" src="../assets/images/login_signup/2.png" alt="login logo"/><img class="cloud-logo3" src="../assets/images/login_signup/2.png" alt="login logo"/><img class="cloud-logo4" src="../assets/images/login_signup/2.png" alt="login logo"/><img class="has-logo1" src="../assets/images/login_signup/4.png" alt="login logo"/>
                  </div>
                </div>
              </div>
            </div>
...
<!-- Mirrored from themes.pixelstrap.com/chitchat/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jan 2024 17:40:58 GMT -->
</html>
